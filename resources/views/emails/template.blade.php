...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<tbody>
		<tr>
			<td style="border: 1px solid #4fba5d; text-align: center; padding: 15px;border-radius: 5px 5px 0px 0px;">
				<a href="#"><img src="{{asset('/assets/img/logo.png') }}" alt="#"></a>
			</td>
		</tr>
		<tr>
			<td colspan="2" style="border: 1px solid #4fba5d; border-top:0px; border-bottom: 0px; padding: 15px;">
		...
		<tr>
			<td colspan="2" style="font-family: sans-serif;font-weight:normal;color:#fff;font-size:14px;line-height:20px; padding: 20px 10px 5px 10px; text-align: center; background: #4fba5d;">
				<table cellspacing="0" cellpadding="0" align="center" style="width: 650px; margin: 0 auto; font-family: arial;">
					
					<tr>
						<td style="padding: 20px 0px 10px 0px;text-align: center;font-family: sans-serif;">
							<span style="display: inline-block; padding: 5px 10px 0px 10px;"><a href="http://bit.ly/2HvHlcs"><img alt="Download Android App" src="{{asset('/assets/img/ios.png') }}" style="width:134px;outline:0" /> </a></span>
					...
					<tr>
						<td style="text-align:center;padding:20px 20px 5px 20px;font-family: sans-serif;font-size:14px;color:#fff;font-weight:normal;line-height:16px">Bringoo Pvt. Ltd. Mumbai-13, Maharashtra</td>
					</tr>
					<tr>
