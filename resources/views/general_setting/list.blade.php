        ...
        <div class="">
			...
			<div class="x_content">
				...
				<!-- New Access Rights Ending -->
					...
					@endcan
					@can('stripesetting_view')
						<li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('setting/razorpay/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-razorpay">&nbsp;</i>Razorpay Settings</a></li>
					@endcan
					...
					<div class="x_panel">
						<div class="x_content">
							<form id="general_setting_edit_form" method="post" action="{{ url('setting/general_setting/store') }}" enctype="multipart/form-data" class="form-horizontal upperform">
				                ...
				                <div class="form-group col-md-12 col-sm-12 col-xs-12  has-feedback my-form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12" for="Country">Payment Getway <label class="color-danger">*</label>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select class="form-control" name="payment_gatway_type" id="payment_gatway_type" required>
											<option value=""> Select Payment Getway Type </option>
										
											<option value="1" <?php if($settings_data->payment_gatway_type==1){ echo "selected"; }?>>Razorpay</option>
											<option value="2" <?php if($settings_data->payment_gatway_type==2){ echo "selected"; }?>>Stripe</option>
