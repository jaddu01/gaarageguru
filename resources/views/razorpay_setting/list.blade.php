        ...
        <div class="">
			...
			<div class="x_content">
				...
				<!-- New Access Rights Ending -->
					...
					@endcan
					@can('stripesetting_view')
						<li role="presentation" class="active suppo_llng_li_add floattab"><a href="{!! url('setting/razorpay/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-razorpay">&nbsp;</i>Razorpay Settings</a></li>
					@endcan
            ...
            <div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						@can('stripesetting_view')
							<form id="stripe_settings_edit_form" method="post" action="{{ url('setting/razorpay/store') }}" enctype="multipart/form-data" class="form-horizontal upperform">
					
								<div class="col-md-12 col-sm-12 col-xs-12">
								  	<h4><b>Razorpay API Key Information :  Update Your Live Razorpay Keys Here ! </b></h4>
								...
								<div class="form-group col-md-12 col-sm-12 col-xs-12  has-feedback my-form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12" for="publish_key">Razorpay Publishable key <label class="color-danger">*</label>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="publish_key" class="form-control" placeholder="Razorpay Publishable key" required maxlength="50" value="{{ $settings_data->publish_key }}">
								...
								<div class="form-group col-md-12 col-sm-12 col-xs-12  has-feedback my-form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12" for="secret_key"Publishable Secret key <label class="color-danger">Razorpay Secret key*</label>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="secret_key" class="form-control" placeholder="Razorpay Secret key" required value="{{ $settings_data->secret_key }}">
								...
								<input type="hidden" name="razorpay_id" value="{{$settings_data->razorpay_id}}">	
