...
Route::post('login-post', 'homeController@loginPost')->name('login-post');
Route::post('otpverify-post', 'homeController@otpverifyPost')->name('otpverify-post');
...
{
	Route::get('list',['as'=>'/booking/list','uses'=>'BookingController@bookingtlist'])->middleware('can:bookingmethod_view');

});
// join type
Route::group(['prefix'=>'join-the-team'],function()
{
	Route::get('list',['as'=>'/join-the-team/list','uses'=>'JoinTeamController@jointheteamlist'])->middleware('can:jointheteammethod_view');
...
Route::post('razorpay-payment','InvoicePaymentController@stripe')->name('razorpay.payment.store');
//Route::post('razorpay-payment', [InvoicePaymentController::class, 'stripe'])->name('razorpay.payment.store');
...
//rozarpay setting routes
	Route::get('/razorpay/list',['as'=>'timezonelist','uses'=>'Timezonecontroller@razorpayList']);
	Route::post('/razorpay/store',['as'=>'storetimezone','uses'=>'Timezonecontroller@razorpayStore']);
