		...
		<div class="row " id="invoice_print">
			...
			<!-- Custom Field Invoice Customer Module (User table)-->
               ...
               ?>
				...
				<table class="table table-bordered itemtable" width="100%" border="1" style="border-collapse:collapse;">
					<tr style="background-color:#4E5E6A;color:#fff; border-right: 0px;border-left: 0px;">
					   <th align="center" style="font-size:14px;padding:8px;border-left: 0px; border-right: 0px;" colspan="7">{{ trans('app.WASH BAY SERVICE CHARGE') }}</th>
					</tr>
					<tr>
					   <th align="center" style="padding:8px;">#</th>
					   <th align="center" style="padding:8px;" colspan="4">{{ trans('app.Charge for')}}</th>
					   <th align="center" style="padding:8px;">{{ trans('app.Price')}} (<?php echo getCurrencySymbols(); ?>)</th>
					   <th align="center" style="padding:8px;">{{ trans('app.Total Price')}} (<?php echo getCurrencySymbols(); ?>) </th>
					</tr>
					...
					<tr>
					   <td align="center" style="padding:8px;">1</td>
					   <td align="center" style="padding:8px;" colspan="4">{{ trans('app.Wash Bay Service')}}</td>
					   <td align="center" style="padding:8px;"><?php echo number_format((float)$washbay_data->price, 2); ?></td>
				...
				<table class="table table-bordered itemtable" width="100%" border="1" style="border-collapse:collapse;">
					...
					<tbody>
						<tr>
						   	...
						   	<td align="right" style="padding:8px;" ><b><?php $total_amt = $total1 + $total2 + $total3 + $total4 + $fix; echo number_format($total_amt, 2);  ?></b></td>
						</tr>
						<tr>
