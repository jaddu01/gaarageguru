...
<!-- <script src="{{ URL::asset('build/js/Chart.min.js') }}" defer="defer"></script> -->
    ...
    <!-- For Garage wizard steps start -->
        ...
        <div class="row mainRowDiv" isHide="1" style="" isArabic="<?php if(getValue() =='rtl') {echo 'rtl';} else{echo'ltr';}?>">

        	@if(getValue() == 'rtl')
	    
				@if($Customer != 0)
			       	<div class="steps step a-step-one greenCircle step-oneGreen customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Customer-Green.png')}}" alt="Avatar" class="main-image">
				...
				@else
					<a href="customer/add" target="">
						<div class="steps step a-step-one blueCircle step-oneBlue customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Customer-Blue.png')}}" alt="Avatar" class="main-image customerMainImg">
				...
				@if($employee != 0)
					<div class="steps step a-step-two greenCircle step-twoGreen employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Employee-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Employee')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="employee/add" target="">
						<div class="steps step a-step-two blueCircle step-twoBlue employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Employee-Blue.png')}}" alt="Avatar" class="main-image employeeMainImg">
				...
				@if($have_supportstaff != 0)
					<div class="steps step a-step-three greenCircle step-threeGreen supportstaff"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Support-Staff-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Support Staff')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="supportstaff/add" target="">
						<div class="steps step a-step-three blueCircle step-threeBlue supportstaff"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Support-Staff-Blue.png')}}" alt="Avatar" class="main-image supportstaffMainImg">
				...
				@if($Supplier != 0)
					<div class="steps step a-step-four greenCircle step-fourGreen supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Supplier-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Supplier')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="supplier/add" target="">
						<div class="steps step a-step-four blueCircle step-fourBlue supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Supplier-Blue.png')}}" alt="Avatar" class="main-image supplierMainImg">
				...
				@if($have_vehicle != 0)
					<div class="steps step a-step-five greenCircle step-fiveGreen vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Vehicle-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Vehicles')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="vehicle/add" target="">
						<div class="steps step a-step-five blueCircle step-fiveBlue vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Vehicle-Blue.png')}}" alt="Avatar" class="main-image vehicleMainImg">
				...
				@if($have_product != 0)
					<div class="steps step a-step-six greenCircle step-sixGreen product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Product-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Products')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="product/add" target="">
						<div class="steps step a-step-six blueCircle step-sixBlue product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Product-Blue.png')}}" alt="Avatar" class="main-image productMainImg">
				...
				@if($have_purchase != 0)
					<div class="steps step a-step-seven greenCircle step-sevenGreen purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Purchase-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Purchase')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="purchase/add" target="">
						<div class="steps step a-step-seven blueCircle step-sevenBlue purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Purchase-Blue.png')}}" alt="Avatar" class="main-image purchaseMainImg">
				...
				@if($have_observationCount != 0)
					<div class="steps step a-step-eight greenCircle step-eightGreen observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Observation-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Observation Library')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="observation/add" target="">
						<div class="steps step a-step-eight blueCircle step-eightBlue observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Observation-Blue.png')}}" alt="Avatar" class="main-image observationMainImg">
			...
			@else
				...
				@if($Customer != 0)
			       	<div class="steps step step-one greenCircle step-oneGreen customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Customer-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Customer')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="customer/add" target="">
						<div class="steps step step-one blueCircle step-oneBlue customer"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Customer-Blue.png')}}" alt="Avatar" class="main-image customerMainImg">
							<span class="name-text_blue">{{ trans('app.Customer')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
				...
				@if($employee != 0)
					<div class="steps step step-two greenCircle step-twoGreen employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Employee-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Employee')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="employee/add" target="">
						<div class="steps step step-two blueCircle step-twoBlue employee"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Employee-Blue.png')}}" alt="Avatar" class="main-image employeeMainImg">
							<span class="name-text_blue">{{ trans('app.Employee')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
				...
				@if($have_supportstaff != 0)
					<div class="steps step step-three greenCircle step-threeGreen supportstaff"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Support-Staff-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Support Staff')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="supportstaff/add" target="">
						<div class="steps step step-three blueCircle step-threeBlue supportstaff"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Support-Staff-Blue.png')}}" alt="Avatar" class="main-image supportstaffMainImg">
							<span class="name-text_blue">{{ trans('app.Support Staff')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
				...
				@if($Supplier != 0)
					<div class="steps step step-four greenCircle step-fourGreen supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Supplier-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Supplier')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="supplier/add" target="">
						<div class="steps step step-four blueCircle step-fourBlue supplier"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Supplier-Blue.png')}}" alt="Avatar" class="main-image supplierMainImg">
							<span class="name-text_blue">{{ trans('app.Supplier')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
				...
				@if($have_vehicle != 0)
					<div class="steps step step-five greenCircle step-fiveGreen vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Vehicle-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Vehicles')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="vehicle/add" target="">
						<div class="steps step step-five blueCircle step-fiveBlue vehicle"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Vehicle-Blue.png')}}" alt="Avatar" class="main-image vehicleMainImg">
							<span class="name-text_blue">{{ trans('app.Vehicles')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
				...
				@if($have_product != 0)
					<div class="steps step step-six greenCircle step-sixGreen product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Product-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Products')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="product/add" target="">
						<div class="steps step step-six blueCircle step-sixBlue product"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Product-Blue.png')}}" alt="Avatar" class="main-image productMainImg">
							<span class="name-text_blue">{{ trans('app.Products')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
				...
				@if($have_purchase != 0)
					<div class="steps step step-seven greenCircle step-sevenGreen purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Purchase-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Purchase')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="purchase/add" target="">
						<div class="steps step step-seven blueCircle step-sevenBlue purchase"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Purchase-Blue.png')}}" alt="Avatar" class="main-image purchaseMainImg">
							<span class="name-text_blue">{{ trans('app.Purchase')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
				...
				@if($have_observationCount != 0)
					<div class="steps step step-eight greenCircle step-eightGreen observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Observation-Green.png')}}" alt="Avatar" class="main-image">
						<span class="name-text_green">{{ trans('app.Observation Library')}}</span>
						<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Check.png')}}" alt="Avatar" class="imgs">
					</div>
				@else
					<a href="observation/add" target="">
						<div class="steps step step-eight blueCircle step-eightBlue observation"><img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/Observation-Blue.png')}}" alt="Avatar" class="main-image observationMainImg">
							<span class="name-text_blue">{{ trans('app.Observation Library')}}</span>
							<img src="{{ URL::asset('public/img/dashboard/wizard_setup_image/3-dot.png')}}" alt="Avatar" class="imgs">
						</div>
					</a>
...
<!-- Active(login) in show admin , supportstaff,accountant -->
	@if(getUsersRole(Auth::user()->role_id) == 'Super Admin' || getUsersRole(Auth::user()->role_id) == 'Support Staff' || getUsersRole(Auth::user()->role_id) == 'Accountant' || getUsersRole(Auth::user()->role_id) == 'Branch Admin')		
		@can('dashboard_view')
