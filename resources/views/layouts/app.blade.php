            		...
            		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              			<div class="menu_section">
                			<ul class="nav side-menu">
			                	...
			                	<li><a><i class="fa fas fa-car"></i> {{ trans('app.Vehicles')}} <span class="fa fa-chevron-down"></span></a>
			                    	<ul class="nav child_menu">
			                    		@can('vehicle_view')
							...
							@if(!empty(Auth::user()->id))
					 			@if(Auth::user()->role=='admin')
						  			<li>	<a href="{!! url('/booking/list')!!}"><i class="fa fa-university"></i> {{ trans('Booking')}} </a></li>
								@endif
							@endif
								@if(!empty(Auth::user()->id))
					 			@if(Auth::user()->role=='admin')
						  			<li>	<a href="{!! url('/join-the-team/list')!!}"><i class="fa fa-university"></i> {{ trans('Join The Team')}} </a></li>
								@endif
							@endif
                			</ul>
              			</div>
